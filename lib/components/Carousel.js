...
var Carousel = function (_Component) {
    ...
    function Carousel(props) {
        ...
        _this.autoPlay = function () {
            ...
            _this.timer = setTimeout(function () {
                _this.increment(1, false, 'auto-play');
        ...
        _this.navigateWithKeyboard = function (e) {
            ...
            if (nextKey === e.keyCode) {
                _this.increment(1, false, 'key-next');
            } else if (prevKey === e.keyCode) {
                _this.decrement(1, false, 'key-prev');
            }
        };
        ...
        _this.handleOnChange = function (index, item, srcType) {
            if (_react.Children.count(_this.props.children) <= 1) {
                return;
            }

            _this.props.onChange(index, item, srcType);
            switch (srcType) {
                case 'click-dot':
                case 'click-prev':
                case 'swipe-prev':
                ...
                case 'key-prev':
                case 'click-thumb':
                    _this.props.onUserChange(index, item, srcType);
                    break;
                default:
                // receive-props
                // auto-play
        ...
        _this.decrement = function () {
            ...
            var srcType = arguments[2];

            _this.moveTo(_this.state.selectedItem - (typeof positions === 'number' ? positions : 1), fromSwipe, srcType);
        };
        ...
        _this.moveTo = function (position, fromSwipe, srcType) {
        ...
        _this.onClickNext = function () {
            _this.increment(1, false, 'click-next');
        };

        _this.onClickPrev = function () {
            _this.decrement(1, false, 'click-prev');
        };

        _this.onSwipeForward = function () {
            _this.increment(1, true, 'swipe-next');
        };

        _this.onSwipeBackwards = function () {
            _this.decrement(1, true, 'swipe-prev');
        };
        ...
        _this.selectItem = function (state, cb, srcType) {
            _this.setState(state, cb);
            _this.handleOnChange(state.selectedItem, _react.Children.toArray(_this.props.children)[state.selectedItem], srcType);
        };
    ...
    _createClass(Carousel, [{
        ...
        value: function componentDidUpdate(prevProps, prevState) {
            ...
            var propsCount = _react.Children.count(this.props.children);
            var prevPropsCount = _react.Children.count(prevProps.children);
            if (propsCount > prevPropsCount) {
                // in this case moveTo in componentWillReceiveProps didn't work
...
Carousel.propTypes = {
    ...
    onUserChange: _propTypes2.default.func.isRequired,
